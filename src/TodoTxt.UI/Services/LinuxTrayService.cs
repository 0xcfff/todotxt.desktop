...
{
    /// <summary>
    /// Linux-specific tray service implementation
...
#pragma warning restore CS0067
        ...
        public void Show()
        {
            ...
            IsVisible = true;
            System.Diagnostics.Debug.WriteLine("Linux tray icon shown (placeholder)");
        }

        public void Hide()
        {
            IsVisible = false;
            System.Diagnostics.Debug.WriteLine("Linux tray icon hidden (placeholder)");
        }
        ...
        public void ShowBalloonTip(string title, string text, int timeout = 5000)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"Linux notification: {title} - {text}");
        }
