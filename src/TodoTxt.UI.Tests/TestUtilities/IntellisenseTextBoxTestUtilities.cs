...
namespace TodoTxt.UI.Tests.TestUtilities;
...
public static class IntellisenseTextBoxTestUtilities
{
    ...
    public static TodoTxt.Core.Tasks.TaskList CreateStandardTestSetup(IntellisenseTextBox textBox, TodoTxt.Core.Tasks.TaskList? taskList = null)
    {
        if (taskList == null)
        {
            taskList = new TodoTxt.Core.Tasks.TaskList();
            taskList.Tasks.Add(new TodoTxt.Core.Tasks.Task("Buy groceries +shopping @home"));
            taskList.Tasks.Add(new TodoTxt.Core.Tasks.Task("Call mom @phone"));
            taskList.Tasks.Add(new TodoTxt.Core.Tasks.Task("Finish project report +work @office"));
            taskList.Tasks.Add(new TodoTxt.Core.Tasks.Task("(A) High priority task +important"));
            taskList.Tasks.Add(new TodoTxt.Core.Tasks.Task("(B) Medium priority task +work"));
